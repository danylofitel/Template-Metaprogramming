...
template<size_t A11, size_t A12, size_t A21, size_t A22, size_t Pow>
struct Matrix2X2Power
{
	...
	typedef Matrix2X2Power<s11, s12, s21, s22, Pow / 2> SQ;
...
struct Matrix2X2Power <A11, A12, A21, A22, 0>
{
	static const size_t
		_11 = 1, _12 = 0,
		_21 = 0, _22 = 1;
...
{
	enum { value = Matrix2X2Power<1, 1, 1, 0, N - 1>::_11 };
};
